...
struct firedtv_tuner_status {
	unsigned active_system;
	unsigned searching;
	unsigned moving;
	unsigned no_rf;
	unsigned input;
	unsigned selected_antenna;
	unsigned ber;
	unsigned signal_strength;
	unsigned raster_frequency;
	unsigned rf_frequency;
	unsigned man_dep_info_length;
	unsigned front_end_error;
	unsigned antenna_error;
	unsigned front_end_power_status;
	unsigned power_supply;
	unsigned carrier_noise_ratio;
	unsigned power_supply_voltage;
	unsigned antenna_voltage;
	unsigned firewire_bus_voltage;
	unsigned ca_mmi;
	unsigned ca_pmt_reply;
	unsigned ca_date_time_request;
	unsigned ca_application_info;
	unsigned ca_module_present_status;
	unsigned ca_dvb_flag;
	unsigned ca_error_flag;
	unsigned ca_initialization_status;
};

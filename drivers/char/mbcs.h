...
union cm_status {
	...
	struct {
		uint64_t pending_reads,	// 7:0
		 pending_writes,	// 15:8
		 ice_rsp_credits,	// 23:16
		 ice_req_credits,	// 31:24
		 cm_req_credits,	// 39:32
		:1,		// 40
		 rd_dma_in_progress,	// 41
		 rd_dma_done,	// 42
		:1,		// 43
		 wr_dma_in_progress,	// 44
		 wr_dma_done,	// 45
		 alg_waiting,	// 46
		 alg_pipe_running,	// 47
		 alg_done,	// 48
		:3,		// 51:49
		 pending_int_reqs,	// 59:52
		:3,		// 62:60
		 alg_half_speed_sel;	// 63
	};
};
...
union cm_error_status {
	...
	struct {
		uint64_t ecc_sbe,	// 0
		 ...
		 request_timeout,	// 7
		:8,		// 15:8
		 head_inv_data_size,	// 16
		 rsp_pactype_inv,	// 17
		 head_sb_err,	// 18
		 missing_head,	// 19
		 head_inv_rd_type,	// 20
		 head_cmd_err_bit,	// 21
		 req_addr_align_inv,	// 22
		 pio_req_addr_inv,	// 23
		 req_range_dsize_inv,	// 24
		 early_term,	// 25
		 early_tail,	// 26
		 missing_tail,	// 27
		 data_flit_sb_err,	// 28
		 cm2hcm_req_cred_of,	// 29
		 cm2hcm_rsp_cred_of,	// 30
		 rx_bad_didn,	// 31
		 rd_dma_err_rsp,	// 32
		 rd_dma_tnum_tout,	// 33
		 rd_dma_multi_tnum_tou,	// 34
		 wr_dma_err_rsp,	// 35
		 wr_dma_tnum_tout,	// 36
		 wr_dma_multi_tnum_tou,	// 37
		 alg_data_overflow,	// 38
		 alg_data_underflow,	// 39
		 ram0_access_conflict,	// 40
		 ram1_access_conflict,	// 41
		 ram2_access_conflict,	// 42
		 ram0_perr,	// 43
		 ram1_perr,	// 44
		 ram2_perr,	// 45
		 int_gen_rsp_err,	// 46
		 int_gen_tnum_tout,	// 47
		 rd_dma_prog_err,	// 48
		 wr_dma_prog_err,	// 49
		:14;		// 63:50
	};
...
union cm_clr_error_status {
	...
	struct {
		uint64_t clr_ecc_sbe,	// 0
		 clr_ecc_mbe,	// 1
		 clr_unsupported_req,	// 2
		 clr_unexpected_rsp,	// 3
		 clr_bad_length,	// 4
		 clr_bad_datavalid,	// 5
		 clr_buffer_overflow,	// 6
		 clr_request_timeout,	// 7
		:8,		// 15:8
		 clr_head_inv_data_siz,	// 16
		 clr_rsp_pactype_inv,	// 17
		 clr_head_sb_err,	// 18
		 clr_missing_head,	// 19
		 clr_head_inv_rd_type,	// 20
		 clr_head_cmd_err_bit,	// 21
		 clr_req_addr_align_in,	// 22
		 clr_pio_req_addr_inv,	// 23
		 clr_req_range_dsize_i,	// 24
		 clr_early_term,	// 25
		 clr_early_tail,	// 26
		 clr_missing_tail,	// 27
		 clr_data_flit_sb_err,	// 28
		 clr_cm2hcm_req_cred_o,	// 29
		 clr_cm2hcm_rsp_cred_o,	// 30
		 clr_rx_bad_didn,	// 31
		 clr_rd_dma_err_rsp,	// 32
		 clr_rd_dma_tnum_tout,	// 33
		 clr_rd_dma_multi_tnum,	// 34
		 clr_wr_dma_err_rsp,	// 35
		 clr_wr_dma_tnum_tout,	// 36
		 clr_wr_dma_multi_tnum,	// 37
		 clr_alg_data_overflow,	// 38
		 clr_alg_data_underflo,	// 39
		 clr_ram0_access_confl,	// 40
		 clr_ram1_access_confl,	// 41
		 clr_ram2_access_confl,	// 42
		 clr_ram0_perr,	// 43
		 clr_ram1_perr,	// 44
		 clr_ram2_perr,	// 45
		 clr_int_gen_rsp_err,	// 46
		 clr_int_gen_tnum_tout,	// 47
		 clr_rd_dma_prog_err,	// 48
		 clr_wr_dma_prog_err,	// 49
		:14;		// 63:50
	};
};
...
union cm_error_intr_enable {
	...
	struct {
		uint64_t int_en_ecc_sbe,	// 0
		 int_en_ecc_mbe,	// 1
		 int_en_unsupported_re,	// 2
		 int_en_unexpected_rsp,	// 3
		 int_en_bad_length,	// 4
		 int_en_bad_datavalid,	// 5
		 int_en_buffer_overflo,	// 6
		 int_en_request_timeou,	// 7
		:8,		// 15:8
		 int_en_head_inv_data_:1,	// 16
		 int_en_rsp_pactype_in,	// 17
		 int_en_head_sb_err,	// 18
		 int_en_missing_head,	// 19
		 int_en_head_inv_rd_ty,	// 20
		 int_en_head_cmd_err_b,	// 21
		 int_en_req_addr_align,	// 22
		 int_en_pio_req_addr_i,	// 23
		 int_en_req_range_dsiz,	// 24
		 int_en_early_term,	// 25
		 int_en_early_tail,	// 26
		 int_en_missing_tail,	// 27
		 int_en_data_flit_sb_e,	// 28
		 int_en_cm2hcm_req_cre,	// 29
		 int_en_cm2hcm_rsp_cre,	// 30
		 int_en_rx_bad_didn,	// 31
		 int_en_rd_dma_err_rsp,	// 32
		 int_en_rd_dma_tnum_to,	// 33
		 int_en_rd_dma_multi_t,	// 34
		 int_en_wr_dma_err_rsp,	// 35
		 int_en_wr_dma_tnum_to,	// 36
		 int_en_wr_dma_multi_t,	// 37
		 int_en_alg_data_overf,	// 38
		 int_en_alg_data_under,	// 39
		 int_en_ram0_access_co,	// 40
		 int_en_ram1_access_co,	// 41
		 int_en_ram2_access_co,	// 42
		 int_en_ram0_perr,	// 43
		 int_en_ram1_perr,	// 44
		 int_en_ram2_perr,	// 45
		 int_en_int_gen_rsp_er,	// 46
		 int_en_int_gen_tnum_t,	// 47
		 int_en_rd_dma_prog_er,	// 48
		 int_en_wr_dma_prog_er,	// 49
		:14;		// 63:50
	};
};
...
union dma_amo_dest {
	...
	struct {
		uint64_t dma_amo_sys_addr,	// 55:0
		 dma_amo_mod_type,	// 58:56
		:5;		// 63:59
	};
};
...
union rdma_aux_status {
	...
	struct {
		uint64_t op_num_pacs_left,	// 16:0
		:5,		// 21:17
		 lrsp_buff_empty,	// 22
		:17,		// 39:23
		 pending_reqs_left,	// 45:40
		:18;		// 63:46
	};
};

...
union ich8_hws_flash_status {
	struct ich8_hsfsts {
		u16 flcdone;	/* bit 0 Flash Cycle Done */
		u16 flcerr;	/* bit 1 Flash Cycle Error */
		u16 dael;	/* bit 2 Direct Access error Log */
		u16 berasesz;	/* bit 4:3 Sector Erase Size */
		u16 flcinprog;	/* bit 5 flash cycle in Progress */
		u16 reserved1;	/* bit 13:6 Reserved */
		u16 reserved2;	/* bit 13:6 Reserved */
		u16 fldesvalid;	/* bit 14 Flash Descriptor Valid */
		u16 flockdn;	/* bit 15 Flash Config Lock-Down */
	} hsf_status;
	u16 regval;
};
...
union ich8_hws_flash_ctrl {
	struct ich8_hsflctl {
		u16 flcgo;	/* 0 Flash Cycle Go */
		u16 flcycle;	/* 2:1 Flash Cycle */
		u16 reserved;	/* 7:3 Reserved  */
		u16 fldbcount;	/* 9:8 Flash Data Byte Count */
		u16 flockdn;	/* 15:10 Reserved */
	} hsf_ctrl;
	u16 regval;
};
...
union ich8_hws_flash_regacc {
	struct ich8_flracc {
		u32 grra;	/* 0:7 GbE region Read Access */
		u32 grwa;	/* 8:15 GbE region Write Access */
		u32 gmrag;	/* 23:16 GbE Master Read Access Grant */
		u32 gmwag;	/* 31:24 GbE Master Write Access Grant */
	} hsf_flregacc;
	u16 regval;
};
...
union ich8_flash_protected_range {
	struct ich8_pr {
		u32 base;	/* 0:12 Protected Range Base */
		u32 reserved1;	/* 13:14 Reserved */
		u32 rpe;	/* 15 Read Protection Enable */
		u32 limit;	/* 16:28 Protected Range Limit */
		u32 reserved2;	/* 29:30 Reserved */
		u32 wpe;	/* 31 Write Protection Enable */
	} range;
	u32 regval;
};
